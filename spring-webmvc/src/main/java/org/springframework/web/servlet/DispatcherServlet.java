...
public class DispatcherServlet extends FrameworkServlet {
	 ...
	 *
	 * 初始化该类使用的处理器映射器.
	 * 如果在此名称空间的BeanFactory中没有定义HandlerMapping bean，则默认为BeanNameUrlHandlerMapping。
	 */
	 ...
	 *
	 * 初始化该类使用的处理器适配器.
	 * 如果在此名称空间的BeanFactory中没有定义HandlerAdapter bean，则默认为SimpleControllerHandlerAdapter。
	 */
	 ...
	 *
	 * 初始化这个servlet实例使用的FlashMapManager。
